...
const DEFAULT_THRESHOLDS: Record<string, number> = {
  ...
  commercial_reg_urgent_days: 30, commercial_reg_high_days: 45, commercial_reg_medium_days: 60,
  health_insurance_urgent_days: 30, health_insurance_high_days: 45, health_insurance_medium_days: 60,
  power_subscription_urgent_days: 30, power_subscription_high_days: 45, power_subscription_medium_days: 60,
  moqeem_subscription_urgent_days: 30, moqeem_subscription_high_days: 45, moqeem_subscription_medium_days: 60,
}
