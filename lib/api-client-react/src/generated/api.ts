 ...
 */
export const deleteAdminProject = async (id: string, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getDeleteAdminProjectUrl(id),
  {
    ...options,
    method: 'DELETE'
 ...
 */
export const deleteAdminExtract = async (id: string, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getDeleteAdminExtractUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const addAdminExtractLine = async (id: string,
    addExtractLineRequest: AddExtractLineRequest, options?: RequestInit): Promise<ExtractLine> => {

  return customFetch<ExtractLine>(getAddAdminExtractLineUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const updateAdminExtractLine = async (lineId: string,
    updateExtractLineRequest: UpdateExtractLineRequest, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getUpdateAdminExtractLineUrl(lineId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
 ...
 */
export const deleteAdminExtractLine = async (lineId: string, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getDeleteAdminExtractLineUrl(lineId),
  {
    ...options,
    method: 'DELETE'
